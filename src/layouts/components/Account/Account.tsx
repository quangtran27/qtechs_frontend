...
function Account() {
  ...
  return (
    <div>
          ...
          <Popper title='Tài khoản' defaultContent={'account'}>
            <section className='w-100 mt-2 mb-2'>
              ...
              <MenuItem
                ...
                disabled
                iconLeft={<LocationIcon className='fill-blue' />}
                iconRight={<AngleRightIcon className={cx('arrow')} />}
              />
            </section>
            ...
            <section>
              <div className='w-100 mt-2 mb-2'>
                <MenuItem
                  ...
                  iconLeft={<CartIcon className='text-blue' />}
                  iconRight={<AngleRightIcon />}
                />
                <div className='d-flex mt-2'>
                  <MenuItem
                    content='Chờ'
                    content2='Thanh toán'
                    iconLeft={<WalletIcon className='fill-cyan' />}
                    vertical
                  />
                  <MenuItem
                    vertical
                    content='Có tại'
                    content2='Cửa hàng'
                    iconLeft={<BoxIcon className='fill-cyan' />}
                  />
                  <MenuItem
                    vertical
                    content='Đang'
                    content2='Vận chuyển'
                    iconLeft={
                      <TruckIcon width={32} height={32} className='fill-cyan' />
                    }
                  />
                  <MenuItem
                    vertical
                    ...
                    content2='Đánh giá'
                    iconLeft={
                      <CommentDots className='fill-cyan' width={32} height={32} />
                    }
                  />
                </div>
              </div>
            ...
            <section>
              ...
              <MenuItem
                ...
                iconLeft={
                  <BookMarkIcon width={20} height={20} className='fill-blue' />
                }
                iconRight={<AngleRightIcon />}
              />
            </section>
            ...
            <section>
              ...
              />
              <MenuItem
                iconLeft={<ShieldCheck className='fill-green' />}
                content='Bảo hành, dổi trả'
                iconRight={<AngleRightIcon />}
              />
              <MenuItem
                iconLeft={<TruckIcon className='fill-primary' />}
                content='Vận chuyển, thanh toán'
                iconRight={<AngleRightIcon />}
              />
              <MenuItem
                iconLeft={<NotebookIcon className='fill-blue' />}
                content='Bảng giá dịch vụ'
                iconRight={<AngleRightIcon />}
              />
              <MenuItem
                iconLeft={<PhoneCallIcon className='fill-primary' />}
            ...
            <section className='mt-2 mb-2'>
              <MenuItem
                iconLeft={<LogoutIcon className='fill-primary' />}
                content='Đăng xuất'
                iconRight={<AngleRightIcon />}
              />
            </section>
      ...
      >
        <Tippy arrow='false' content='Tài khoản' delay={[300, 200]}>
          <div id='account'>
            <Button
